...
export const Footer: React.FC = () => {
  ...
  const socialLinks = [
    ...
    { icon: <Mail size={20} />, href: 'mailto:amarjit@example.com', label: 'Email' },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-foreground/10 mt-12 pt-6 flex flex-col md:flex-row items-center justify-between">
          <p className="text-foreground/60 text-sm">
            &copy; {currentYear} Amarjit Pradhan. All rights reserved.
          </p>
          <p className="text-foreground/60 text-sm mt-2 md:mt-0 flex items-center">
            Made with <Heart size={16} className="mx-1 text-accent" /> by Amarjit Pradhan
          </p>
        </div>
      </div>
    </footer>
